...
var Container = /** @class */ (function (_super) {
    ...
    Container.prototype.convert = function (data) {
        this.offsetX = data.offsetX;
        this.offsetY = data.offsetY;
        this.add.apply(this, __spreadArray([], __read(Container.convert(data)), false));
    };
    ...
    Container.convert = function (data) {
    ...
    Container.serialize = function (container, stringify) {
        ...
        var data = {
            ...
            items: Array.from(container.items).map(function (item) {
                if (item instanceof Curve) {
                    return {
                        type: DrawableType.Curve,
                        points: Array.from(item.points).map(function (_a) {
                            var x = _a.x, y = _a.y;
                            return ({
                                x: x,
                                y: y,
